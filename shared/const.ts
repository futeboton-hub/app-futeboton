...
export const NOT_TENANT_MEMBER_ERR_MSG = 'You are not a member of this tenant (10003)';
export const NOT_TENANT_ADMIN_ERR_MSG = 'Only tenant admins can perform this action (10004)';
export const SINGLE_ADMIN_LIMIT_ERR_MSG = 'Only 1 admin per tenant is allowed (10005)';
